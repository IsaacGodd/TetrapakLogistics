  ...
  return (
    <div className="p-6 space-y-5 bg-app-bg min-h-full">
      ...
      <div className="flex items-start justify-between">
        ...
        <button className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-600 via-teal-600 to-green-600 text-white text-sm rounded-xl font-medium hover:from-blue-700 hover:via-teal-700 hover:to-green-700 transition-all active:scale-95 shadow-sm">
